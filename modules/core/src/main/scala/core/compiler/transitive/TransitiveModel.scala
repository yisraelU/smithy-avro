...
import software.amazon.smithy.model.neighbor.{NeighborProvider, Walker}
...
// credit to https://github.com/disneystreaming/smithy-translate/blob/main/modules/transitive/src/closure/TransitiveModel.scala
